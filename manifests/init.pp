...
class baseline_cfg {
    ...
    include ::chronyd               # beergeek-chronyd, replaces ntp
    include ::ntp                   # puppetlabs-ntp, ensure ntp is not running
    include ::timezone              # saz-timezone
...
#TODO#        include ::baseline_cfg::dns_resolv
#TODO#        include ::baseline_cfg::firewall_config
#TODO#        include ::baseline_cfg::network
#        include ::baseline_cfg::selinux
#        include ::baseline_cfg::sshd
#TODO#        include ::baseline_cfg::syslog
